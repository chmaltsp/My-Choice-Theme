    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 faq">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel panel-body">
                <p>Aut ea sint pariatur. Est legam imitarentur, amet ne in minim litteris et ex aut 
                    concursionibus ad elit firmissimum mentitum culpa laborum. Culpa voluptate aut 
                    exquisitaque. Fabulas velit malis deserunt legam. Malis te quamquam ne culpa. 
                   </p>
            </div>
             <div class="panel-heading">
                <h4>Question 2</h4>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-">
        ...
        <form>
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Enter Username" id="memberUsername">
            </div>
            <div class="form-group">
                <label for="memberPW">Password</label>
                <input class="form-control" type="password" placeholder="Enter Password" id="memberPassword">
            </div>
            <div class="form-group">
